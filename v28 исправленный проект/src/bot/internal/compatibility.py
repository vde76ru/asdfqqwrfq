...
class Compatibility:
    ...
    def _run_async_tasks(self):
        ...
        try:
            ...
            # Импортируем lifecycle для запуска асинхронной части
            from .lifecycle import Lifecycle
            lifecycle = Lifecycle(self.bot)
            
            loop.run_until_complete(lifecycle.start_async())
    ...
    def start_sync(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            self.bot.start_time = self.bot.datetime.utcnow()
